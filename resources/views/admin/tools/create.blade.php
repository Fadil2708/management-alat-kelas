...
@section('page-subtitle', 'Add equipment to inventory')
...
<div class="animate-fade-in max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('admin.tools.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="inventory_code" name="inventory_code" value="{{ old('inventory_code') }}"
                ...
                <div>
                    ...
                    <select id="condition" name="condition"
                        ...
                        <option value="good" {{ old('condition') == 'good' ? 'selected' : '' }}>✅ Good - Like new</option>
                        <option value="fair" {{ old('condition') == 'fair' ? 'selected' : '' }}>⚠️ Fair - Minor wear</option>
                        <option value="poor" {{ old('condition') == 'poor' ? 'selected' : '' }}>❌ Poor - Needs repair</option>
                    </select>
                    @error('condition')
                        <p class="text-red-500 text-xs mt-1 flex items-center gap-1">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 hover:border-indigo-400 transition-colors">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-xs text-gray-500 mt-2">Max file size: 2MB. Accepted formats: JPG, PNG, GIF</p>
                        </div>
                    </div>
                    @error('photo')
                        <p class="text-red-500 text-xs mt-1 flex items-center gap-1">
